...
export const USER_UPDATE_APPLY_JOB_REQUEST = "USER_UPDATE_APPLY_JOB_REQUEST";
export const USER_UPDATE_APPLY_JOB_SUCCESS = "USER_UPDATE_APPLY_JOB_SUCCESS";
export const USER_UPDATE_APPLY_JOB_FAIL = "USER_UPDATE_APPLY_JOB_FAIL";
export const USER_UPDATE_APPLY_JOB_RESET = "USER_UPDATE_APPLY_JOB_RESET";
